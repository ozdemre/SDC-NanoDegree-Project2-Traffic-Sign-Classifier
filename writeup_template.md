...
Then I plotted number of training data per each class.
...
As a last step, I normalized the image data since optimizer numerically works more stable around mean zero value.
...
To increase the accuracy of the model some augmentation techniques can be used. (such as: transforms, rotation, zoom, mirror ..etc)
